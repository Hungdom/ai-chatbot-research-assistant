...
const ChatMessage = ({ message }) => {
  ...
  const proseClasses = isDarkMode
    ? 'prose-invert prose-headings:text-white prose-p:text-white prose-strong:text-white prose-code:text-white prose-pre:bg-gray-900 prose-pre:text-white [&_a]:text-indigo-300 [&_a:hover]:text-indigo-200 [&_ul]:text-white [&_ol]:text-white [&_li]:text-white [&_blockquote]:text-gray-300 [&_blockquote]:border-gray-600 [&_hr]:border-gray-600 [&_table]:text-white [&_th]:border-gray-600 [&_td]:border-gray-600 [&_*]:text-white prose-headings:font-semibold prose-headings:tracking-tight prose-headings:mb-4 prose-headings:mt-8 prose-h2:text-xl prose-h2:border-b prose-h2:border-gray-600 prose-h2:pb-2 prose-h3:text-lg prose-h3:mt-6 prose-h3:mb-3 prose-p:leading-7 prose-p:mb-4 prose-ul:my-4 prose-ul:ml-6 prose-ul:list-disc prose-ol:my-4 prose-ol:ml-6 prose-ol:list-decimal prose-li:my-1 prose-li:leading-7 prose-li:pl-1 prose-blockquote:mt-6 prose-blockquote:border-l-2 prose-blockquote:pl-6 prose-blockquote:italic prose-hr:my-8 prose-hr:border-2 prose-hr:border-gray-600 prose-table:w-full prose-table:border-collapse prose-th:border prose-th:border-gray-600 prose-th:px-4 prose-th:py-2 prose-td:border prose-td:border-gray-600 prose-td:px-4 prose-td:py-2 [&_h2]:flex [&_h2]:items-center [&_h2]:gap-2 [&_h3]:flex [&_h3]:items-center [&_h3]:gap-2'
    : 'prose-headings:text-gray-900 prose-p:text-gray-900 prose-strong:text-gray-900 prose-code:text-gray-900 prose-pre:bg-gray-100 prose-pre:text-gray-900 prose-headings:font-semibold prose-headings:tracking-tight prose-headings:mb-4 prose-headings:mt-8 prose-h2:text-xl prose-h2:border-b prose-h2:border-gray-200 prose-h2:pb-2 prose-h3:text-lg prose-h3:mt-6 prose-h3:mb-3 prose-p:leading-7 prose-p:mb-4 prose-ul:my-4 prose-ul:ml-6 prose-ul:list-disc prose-ol:my-4 prose-ol:ml-6 prose-ol:list-decimal prose-li:my-1 prose-li:leading-7 prose-li:pl-1 prose-blockquote:mt-6 prose-blockquote:border-l-2 prose-blockquote:pl-6 prose-blockquote:italic prose-hr:my-8 prose-hr:border-2 prose-hr:border-gray-200 prose-table:w-full prose-table:border-collapse prose-th:border prose-th:border-gray-200 prose-th:px-4 prose-th:py-2 prose-td:border prose-td:border-gray-200 prose-td:px-4 prose-td:py-2 [&_h2]:flex [&_h2]:items-center [&_h2]:gap-2 [&_h3]:flex [&_h3]:items-center [&_h3]:gap-2';
