...
const Home = () => {
  ...
  return (
    <div className={`relative isolate overflow-hidden ${isDarkMode ? 'bg-gray-900' : 'bg-white'}`}>
      {/* Hero Section */}
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Left Column - Text Content */}
          <div className="max-w-2xl mx-auto lg:mx-0">
            <h1 className={`text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
              Research Assistant
            </h1>
            <p className={`mt-6 text-lg sm:text-xl leading-8 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
              ...
              <Link 
                to="/search" 
                className={`w-full sm:w-auto text-base font-semibold leading-6 ${isDarkMode ? 'text-indigo-400 hover:text-indigo-300' : 'text-gray-900 hover:text-gray-700'} text-center`}
              >
          ...
          <div className="relative max-w-2xl mx-auto lg:mx-0">
            <div className={`absolute -inset-4 bg-gradient-to-r ${isDarkMode ? 'from-indigo-900 to-purple-900' : 'from-indigo-100 to-purple-100'} rounded-2xl opacity-50 blur-xl`}></div>
            <div className={`relative ${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl shadow-xl overflow-hidden`}>
              <div className="p-6">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    <h3 className={`text-lg font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>AI Research Assistant</h3>
                    <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>Ready to help with your research</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className={`${isDarkMode ? 'bg-gray-700' : 'bg-gray-50'} rounded-lg p-4`}>
                    <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>What are the latest developments in quantum computing?</p>
                  </div>
                  <div className={`${isDarkMode ? 'bg-indigo-900' : 'bg-indigo-50'} rounded-lg p-4`}>
                    <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Based on recent papers, there have been significant advances in quantum error correction and quantum supremacy demonstrations...</p>
                    <div className="mt-2 flex flex-wrap gap-2">
                      <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${isDarkMode ? 'bg-indigo-800 text-indigo-200' : 'bg-indigo-100 text-indigo-800'}`}>
                        arXiv:2301.12345
                      </span>
                      <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${isDarkMode ? 'bg-indigo-800 text-indigo-200' : 'bg-indigo-100 text-indigo-800'}`}>
                        Nature, 2023
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className={`mt-2 text-3xl font-bold tracking-tight ${isDarkMode ? 'text-white' : 'text-gray-900'} sm:text-4xl`}>
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
          <dl className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {keyFeatures.map((feature) => (
              <div key={feature.title} className={`flex flex-col ${isDarkMode ? 'bg-gray-800' : 'bg-white'} p-6 rounded-2xl shadow-sm ring-1 ${isDarkMode ? 'ring-gray-700' : 'ring-gray-200'}`}>
                <dt className={`flex items-center gap-x-3 text-base font-semibold leading-7 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div className={`rounded-2xl ${isDarkMode ? 'bg-gray-800' : 'bg-white'} p-6 sm:p-8 shadow-sm ring-1 ${isDarkMode ? 'ring-gray-700' : 'ring-gray-200'}`}>
              <div className="flex items-center space-x-4 mb-6">
                ...
                <h3 className={`text-lg font-semibold leading-8 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Chat Interface</h3>
              </div>
              <ul className={`mt-4 space-y-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <div className={`rounded-2xl ${isDarkMode ? 'bg-gray-800' : 'bg-white'} p-6 sm:p-8 shadow-sm ring-1 ${isDarkMode ? 'ring-gray-700' : 'ring-gray-200'}`}>
              <div className="flex items-center space-x-4 mb-6">
                ...
                <h3 className={`text-lg font-semibold leading-8 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Paper Search</h3>
              </div>
              <ul className={`mt-4 space-y-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                <li className="flex gap-x-3">
                  <span className="text-indigo-600">•</span>
      ...
      <div className="absolute inset-x-0 top-0 -z-10 transform-gpu overflow-hidden blur-3xl" aria-hidden="true">
        <div className={`relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr ${isDarkMode ? 'from-indigo-900 to-purple-900' : 'from-[#ff80b5] to-[#9089fc]'} opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]`}></div>
      </div>
      <div className="absolute inset-x-0 bottom-0 -z-10 transform-gpu overflow-hidden blur-3xl" aria-hidden="true">
        <div className={`relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr ${isDarkMode ? 'from-indigo-900 to-purple-900' : 'from-[#ff80b5] to-[#9089fc]'} opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]`}></div>
      </div>
    </div>
  );
};
